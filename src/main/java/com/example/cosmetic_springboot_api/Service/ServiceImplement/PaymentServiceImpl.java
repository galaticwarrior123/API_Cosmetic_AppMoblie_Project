...
import com.example.cosmetic_springboot_api.Config.PayConfig;
...
public class PaymentServiceImpl implements IPaymentService {
    @Override
    public PaymentResponse createPayment(int amount) throws UnsupportedEncodingException {
        ...
        paymentResponse.setNameUrl(paymentUrl);
        paymentResponse.setPrice(amount);
